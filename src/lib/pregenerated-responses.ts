      ...
      full: {
        ...
        actionPlan: `
          ...
          <ul>
            ...
            <li><strong>Linguagem do Amor:</strong> Identifique a principal linguagem do amor do seu parceiro(a) (palavras, tempo de qualidade, presentes, atos de serviço, toque físico) e faça uma ação deliberada baseada nela hoje. Falar a "língua" do outro é a forma mais eficaz de fazê-lo se sentir amado.</li>
            ...
            <li><strong>Elogio Público Sutil:</strong> Em uma conversa com amigos ou em uma postagem discreta, mencione algo que seu parceiro(a) fez e que você se orgulha. Deixe que ele(a) veja ou ouça isso organicamente. Isso reforça o sentimento de "time". 🤝</li>
      ...
      full: {
        ...
        actionPlan: `
          ...
          <ul>
            ...
            <li><strong>Fofoca do Bem:</strong> Pergunta qual foi o maior mico que ele(a) já pagou. Depois conta o seu. Rir de si mesmo juntos cria uma conexão absurda. É terapia de graça! 🤣</li>
      ...
      full: {
        ...
        actionPlan: `
          ...
          <ul>
            ...
            <li><strong>Definindo Seus Limites Inegociáveis:</strong> Com base na sua lista do Dia 1, escreva 3 a 5 limites inegociáveis. Ex: "Eu preciso ser tratada com respeito, mesmo durante uma discussão" ou "Eu preciso que meu parceiro ouça meus sentimentos sem me invalidar". Isso é seu manifesto pessoal.</li>
            <li><strong>Inventário Emocional Honesto:</strong> Pegue um caderno e escreva como este relacionamento fez você se sentir na última semana/mês. Use palavras brutais, se necessário (ex: "invisível", "carente"). Depois, em outra página, escreva como você GOSTARIA de se sentir em um relacionamento. Compare as duas listas. Este contraste é o seu "porquê". 📝</li>
