    ...
    detailed: {
      ...
      full: {
        ...
        actionPlan: `
          ...
          <p>Este plano não visa "consertá-lo(a)", mas sim quebrar o ciclo vicioso, recuperar seu poder e dar a você a clareza necessária para decidir seus próximos passos. Lembre-se, este é um guia de reflexão e não uma sentença.</p>
          <ul>
            <li><strong>Dia 1 (Observação Passiva):</strong> Tente não iniciar nenhuma conversa. O objetivo é coletar dados: a outra pessoa te procurou? Se sim, como foi a conversa? Anote mentalmente. Você está no modo cientista. 👩‍🔬</li>
            <li><strong>Dia 2 (Espelhamento de Energia):</strong> Se a pessoa te procurar, responda com o mesmo nível de energia. Se a mensagem for curta e direta ("Tudo bem?"), responda de forma similar ("Tudo ótimo e por aí?"). Não dê mais do que recebe. Isso ajuda a reequilibrar a dinâmica.</li>
            ...
            <li><strong>Dia 5 (O Convite de Baixo Risco):</strong> Proponha algo concreto, casual e com um prazo definido. Ex: "Estou pensando em ir naquele café novo no sábado à tarde. Se estiver livre e a fim, me avise até amanhã à noite". Isso coloca a bola no campo do outro sem te deixar esperando indefinidamente. ☕</li>
            <li><strong>Dia 6 (Reforço Positivo Estratégico):</strong> Se a pessoa demonstrar um comportamento positivo que você deseja (iniciar uma conversa profunda, fazer um plano), reforce. "Adorei conversar com você hoje, foi leve e divertido!". Isso mostra o que você valoriza.</li>
    ...
    gossipy_friend: {
      ...
      full: {
        detailedSummary: `
          ...
          <p>
            Vamos aos fatos: essa pessoa tá operando no modo "Wi-Fi de rodoviária". Uma hora o sinal tá ótimo, vocês conversam, rola uma atenção, você até pensa "agora vai!". De repente, o sinal cai, a mensagem não chega, e você fica lá, olhando pra tela, parecendo uma maluca. 👻
          </p>
          <p>
        ...
        actionPlan: `
          ...
          <ul>
            <li><strong>Dia 1 (Chá de Sumiço Estratégico):</strong> Hoje, você não existe pra essa pessoa. Não manda mensagem, não curte stories, não reage a nada. Deixa a pessoa sentir o vácuo que você preenche na vida dela. Silêncio às vezes grita, meu bem.</li>
            <li><strong>Dia 2 (Modo Ocupada & Importante):</strong> Se a pessoa aparecer, seja simpática, mas direta: "Oii, tudo ótimo! Dia super corrido por aqui, te respondo com calma mais tarde!". E responda SÓ mais tarde mesmo. Mostre que seu tempo é valioso. ⏳</li>
            ...
            <li><strong>Dia 5 (A Isca da Saudade):</strong> Se estiver se sentindo ousada, mande um "Sabe que eu tava lembrando da gente rindo daquela coisa boba? Saudade aleatória disso". É leve, fofo e joga a responsabilidade de continuar o papo pra outra pessoa.</li>
      ...
      full: {
        ...
        actionPlan: `
          ...
          <ul>
            ...
            <li><strong>Dia 4 (Definindo Seus Limites Inegociáveis):</strong> Com base na sua lista do Dia 1, escreva 3 a 5 limites inegociáveis. Ex: "Eu preciso ser tratada com respeito, mesmo durante uma discussão" ou "Eu preciso que meu parceiro ouça meus sentimentos sem me invalidar". Isso é seu manifesto pessoal.</li>
            <li><strong>Dia 5 (Planejando a Conversa Difícil):</strong> Você merece ser ouvida. Planeje o que você dirá, não para acusar, mas para expressar como se sente. Estruture em torno de "Eu". Ex: "Eu tenho me sentido consistentemente desvalorizada e sozinha nesta relação, e isso está me afetando muito. Eu preciso que a gente converse sobre isso abertamente".</li>
            <li><strong>Dia 6 (Busque Apoio Profissional):</strong> Considere seriamente a possibilidade de terapia, seja individual (para você) ou de casal. Um profissional pode mediar a conversa e oferecer ferramentas que vocês sozinhos talvez não encontrem. Este é um passo de coragem, não de fraqueza.</li>
            <li><strong>Dia 7 (A Conversa Libertadora):</strong> Tenha a conversa que planejou no Dia 5. Seja clara e firme nos seus sentimentos e limites. A reação da outra pessoa — se ela demonstrar remorso e disposição para mudar, ou se continuar na defensiva — será o dado mais concreto que você terá para decidir seus próximos passos.</li>
          </ul>
    ...
    gossipy_friend: {
      ...
      full: {
        detailedSummary: `
          ...
          <p>
            Sério, vamos ser brutalmente honestas. Pelo que você contou, isso não é uma fase ruim, é um padrão de comportamento tóxico. Você fala, você se importa, você tenta... e a outra pessoa? Te trata com a mesma empolgação de quem preenche formulário de imposto de renda. 😴
          </p>
          <p>
